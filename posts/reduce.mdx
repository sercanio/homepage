...
This may mean taking an accumulator that is a number and returning its value + 1, or taking an accumulator which is an array and returning that array with an additional element on the end. It's up to you, depending what type of data you would like to _reduce_ your array to. It's up to you, depending what type of data you would like to _reduce_ your array to It's up to you, depending what type of data you would like to _reduce_ your array to.
