...
const BlogHome = ({
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-1 xl:gap-4 -ml-[10px] xl:-ml-5 h-screen scroll-smooth justify-between w-full max-w-5xl mt-16 md:mt-20 md:mb-6 px-1">
