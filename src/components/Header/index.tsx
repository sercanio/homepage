...
const Header: React.FC = () => {
  return (
    <header className="bg-skin-base dark:bg-black color-transition py-4 px-6 relative">
      <nav className="flex justify-between items-baseline relative z-10 mb-1 max-w-5xl lg:px-6 mx-auto">
