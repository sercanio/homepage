        ...
        <section className="flex items-baseline gap-16 sm:gap-24 lg:gap-32 xl:gap-48 2xl:gap-64">
          <section className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col [&>a]:flex [&>a]:gap-2 [&>a]:items-center [&>a]:text-skin-base dark:[&>a]:text-skin-dark hover:[&>a]:text-gray-900 dark:hover:[&>a]:text-gray-100 [&>a]:py-2 text-base">
              ...
              <Link href="https://instagram.com/sercan.io">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
                ...
                <span className="sr-only">Sercan&apos;s Instagram profile</span>
                Instagram
              </Link>
              <Link href="https://github.com/sercanio">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
              ...
              <Link href="https://linkedin.com/in/sercanates">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
